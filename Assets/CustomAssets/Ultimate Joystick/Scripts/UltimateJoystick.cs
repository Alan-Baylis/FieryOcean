...
public class UltimateJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
	...
	void Start ()
	{
		...
		// Check all options to see if the joystick hightlight image should be moved with use input.
	...
	/// <summary>
	/// Returns with a confirmation about the existance of the targed Ultimate Joystick.
	/// </summary>
