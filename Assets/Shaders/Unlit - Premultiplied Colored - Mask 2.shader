...
Shader "Hidden/Unlit/Premultiplied Colored - Mask (AOW3) 2" // Основано на шейдере NGUI/Hidden/Unlit/Premultiplied Colored 2
{
	Properties
	{
...
//			ColorMask RGB
	...
	Fallback "Unlit/Premultiplied Colored - Mask (AOW3)"
}