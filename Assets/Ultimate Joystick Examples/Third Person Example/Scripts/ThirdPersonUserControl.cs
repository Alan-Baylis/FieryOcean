...
// Namespace has been changed to avoid any errors with existing scripts from the Standard Assets package by Unity Technologies.
namespace UltimateJoystickExample.ThirdPerson
{
    ...
    public class ThirdPersonUserControl : MonoBehaviour
    {
		...
		// This function is called by the Ultimate Joystick when the right joystick has been tapped twice in quick succession.
